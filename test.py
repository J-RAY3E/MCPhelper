        ...
        try:
            ...
            if urls_to_scrape:
                try:
                    ...
                    print("scrap ")
                    scraped_pages = await scraper.scrape_multiple(urls_to_scrape, max_urls=3,query=topic)
                    print("PASEEN ")
                    if scraped_pages:
                        summary += "\n## 📖 DETAILED CONTENT:\n\n"
...
async def main():
    ...
    result = await tools.autonomous_research("What is the weather like today in Spain?")
